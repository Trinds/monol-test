          ...
          <div class="card mb-3" style="border-radius: .5rem;">
            <div class="row g-0">
              <div class="col-md-4 gradient-custom text-center text-white"
                ...
                @if ($user->image !== null)
                <img src="{{ asset('storage/' . $user->image) }}" alt="User image" class="img-fluid my-5" style='border-radius: 50%; width: 120px; height: 120px;'/>
                @else
                ...
                <a style="color: #f4f5f7" href="{{route('users.edit', $user->id)}}"><i class="far fa-edit mb-5"></i></a>
              </div>
              <div class="col-md-8">

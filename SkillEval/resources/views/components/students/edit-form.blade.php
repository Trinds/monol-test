...
@endif
    <form action="{{url('students/' . $student->id)}}" method="POST" enctype="multipart/form-data" class="create-form">
        ...
        <fieldset class="fieldset">
            ...
            <input type="text" id="student_number" name="student_number" class="form-input" placeholder="Numero do Formando" value="{{ $student->student_number }}" required>

            <label for="email" class="form-label">Email:</label>
            <input type="email" id="email" name="email" class="form-input" placeholder="Email do Formando" value="{{ $student->email }}" required>

            <label for="name" class="form-label">Nome:</label>
            <input type="text" id="name" name="name" class="form-input" placeholder="Nome do Formando" value="{{ $student->name }}" required>

            <label for="birth_date" class="form-label">Data de nascimento:</label>
            <input type="date" id="birth_date" name="birth_date" class="form-input" placeholder="Data de nascimento do formando" value="{{ $student->birth_date }}" required>

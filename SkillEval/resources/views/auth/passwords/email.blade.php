        ...
        <div class="login-card">
            <div class="app-title">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <input id="email" type="email" class="login-form-input-field form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>

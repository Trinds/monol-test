                ...
                @endif
                    <form method="POST" action="{{ route('password.update') }}" class="login-form">
                        ...
                        name="email"  value="{{ $email ?? old('email') }}" required autocomplete="off" autofocus>
                            ...
                            <input id="password" type="password" class="login-form-input-field form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                            </label>
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <label for="password-confirm" class="login-form-input-name">{{ __('Confirme Password') }}
                                <input id="password-confirm" type="password" class="login-form-input-field form-control" name="password_confirmation" required autocomplete="new-password">
                            </label>
